Advanced Excel Sales Dashboard: Superstore Analysis

This is an interactive, one-page sales dashboard built entirely in Advanced Excel. This project transforms a 10,000-row raw sales CSV into an executive-ready tool for analyzing performance.

I wanted to make a project only using my Excel skills.
...
Wrote formulas like =YEAR(), =TEXT(), and [$-409] (for international language handling) to create new "helper" columns for analysis.
...
Cleaned all charts by hiding field buttons to create a polished, professional look.

Interactive Dashboard (The "Magic"):

Added Slicers (for Region and Category) and a Timeline (for Order Date).
...
Click Superstore Sales Dashboard.xlsx from the file list above.
...
Click on a Region (like "East") or Category ("Furniture").

Drag the Order Date Timeline slider.

Watch all four charts update instantly.
